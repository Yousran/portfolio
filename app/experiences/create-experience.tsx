...
const CreateExperience = ({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const response = await fetch('/api/experiences/store', {
            method: 'POST',
            headers: {
        ...
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Please fill in the details for the new experience.
                    </AlertDialogDescription>
                </AlertDialogHeader>
